...
for (int i = 1; i < 2; i++) {
    ...
    response = WS.sendRequest(findTestObject('Change Direct Debit Deposit Account/ProductCd of spaces and accountNbr of 7 sequenceNumberHi 3606339622 SequenceNumberLo 2101125650', 
