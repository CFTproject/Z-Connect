...
for (int i = 9; i < 10; i++) {
    ...
    response = WS.sendRequest(findTestObject('Change Direct Debit Deposit Account/Change originationPorductCode and originationAccountNbr', 
            [('companyNbr') : testdatapath.getValue(2, i), ('productCd') : testdatapath.getValue(4, i), ('accountNbr') : testdatapath.getValue(
                    ...
                    7, i), ('startDate') : testdatapath.getValue(8, i), ('expiryDate') : testdatapath.getValue(9, i), ('originationTransitRouting') : testdatapath.getValue(
