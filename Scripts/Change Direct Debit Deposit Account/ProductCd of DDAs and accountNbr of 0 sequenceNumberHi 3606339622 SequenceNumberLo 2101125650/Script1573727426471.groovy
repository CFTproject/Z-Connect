...
for (int i = 2; i < 3; i++) {
    ...
    response = WS.sendRequest(findTestObject('Change Direct Debit Deposit Account/ProductCd of DDAs and accountNbr of 0 sequenceNumberHi 3606339622 SequenceNumberLo 2101125650', 
