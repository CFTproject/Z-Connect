...
response = WS.sendRequest(findTestObject('Get Address Profile/Get address with Number of accounts greater than 14 and limit 25'))
...
for(int i=5; i<6; i++){
	...
	WS.verifyElementPropertyValue(response, 'getAddressProfileServiceOperationResponse.RESPONSE.Output.deliveryRoute', findTestData('Z-Connect Test Data/Get Address Profile_TestData').getValue(10, i))
	...
	WS.verifyElementPropertyValue(response, 'getAddressProfileServiceOperationResponse.RESPONSE.Output.checkDigit', findTestData('Z-Connect Test Data/Get Address Profile_TestData').getValue(15, i))
	...
	WS.verifyElementPropertyValue(response, 'getAddressProfileServiceOperationResponse.RESPONSE.Output.addressCustomerInfo[0].custTie', findTestData('Z-Connect Test Data/Get Address Profile_TestData').getValue(31, i))
