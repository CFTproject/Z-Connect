...
for (int i = 7; i < 8; i++) {
    response = WS.sendRequest(findTestObject('Delete Restraint Merchant Auth/Delete Restraint Merchant Auth record with all valid non blank input fields for an non-existing record', 
