...
for (int i = 1; i < 2; i++) {
    ...
    response = WS.sendRequest(findTestObject('Get Sweep List/All blank input fields'))
	...
	//WS.verifyElementPropertyValue(response, str+'xStatus.', testdatapath.getValue(, i))
}