...
for (int i = 2; i < 3; i++) {
    response = WS.sendRequest(findTestObject('Create Restraint Merchant Auth/Create Restraint Merchant Auth record with non blank product code and all other blank input fields', 
