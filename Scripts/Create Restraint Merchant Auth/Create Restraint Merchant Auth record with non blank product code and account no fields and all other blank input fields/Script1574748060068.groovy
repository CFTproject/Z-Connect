...
for (int i = 3; i < 4; i++) {
    response = WS.sendRequest(findTestObject('Create Restraint Merchant Auth/Create Restraint Merchant Auth record with non blank product code and account no fields and all other blank input fields', 
