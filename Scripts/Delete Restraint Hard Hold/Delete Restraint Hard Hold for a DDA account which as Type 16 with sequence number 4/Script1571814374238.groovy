...
for (int i = 7; i < 8; i++) {
    ...
    response = WS.sendRequest(findTestObject('Delete Restraint Hard Hold/Delete Restraint Hard Hold for a DDA account which as Type 16 with sequence number 4', 
