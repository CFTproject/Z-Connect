...
for (int i = 1; i < 14; i++) {
	...
	println ('APPLICATION CODE :- '+findTestData('Z-Connect Test Data/Create Restraint Pledge To_TestData').getValue(20, i))
	println ('STATUS CODE :- '+findTestData('Z-Connect Test Data/Create Restraint Pledge To_TestData').getValue(21, i))
	println ('STATUS MESSAGE :- '+findTestData('Z-Connect Test Data/Create Restraint Pledge To_TestData').getValue(22, i))
	println ('SEVERITY :- '+findTestData('Z-Connect Test Data/Create Restraint Pledge To_TestData').getValue(23, i))

    response = WS.sendRequest(findTestObject('Create Restraint Pledge To/Create Restraint Pledge To Post Request Verify Response with valid Values', 
 ...
 WS.verifyElementPropertyValue(response, 'createRestraintPledgeToServiceOperationResponse.RESPONSE.Output.xStatus.applicationCd', findTestData('Z-Connect Test Data/Create Restraint Pledge To_TestData').getValue(20, i))
 
 WS.verifyElementPropertyValue(response, 'createRestraintPledgeToServiceOperationResponse.RESPONSE.Output.xStatus.statusCd', findTestData('Z-Connect Test Data/Create Restraint Pledge To_TestData').getValue(21, i))
 
 WS.verifyElementPropertyValue(response, 'createRestraintPledgeToServiceOperationResponse.RESPONSE.Output.xStatus.statusMessage', findTestData('Z-Connect Test Data/Create Restraint Pledge To_TestData').getValue(22, i))
 
 WS.verifyElementPropertyValue(response, 'createRestraintPledgeToServiceOperationResponse.RESPONSE.Output.xStatus.severity', findTestData('Z-Connect Test Data/Create Restraint Pledge To_TestData').getValue(23, i))
