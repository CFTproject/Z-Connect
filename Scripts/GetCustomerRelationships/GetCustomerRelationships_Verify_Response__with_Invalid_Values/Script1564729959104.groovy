...
for (int i = 3; i < 4; i++) {
    ...
    response = WS.sendRequest(findTestObject('GetCustomerRelationships/GetCustomerRelationships_Verify_Response__with_Invalid_Values'))
    ...
    WS.verifyElementPropertyValue(response, str + 'xStatus.severity', testdatapath.getValue(5, i)) /*WS.verifyElementPropertyValue(response, str+'custOffset', testdatapath.getValue(6, i))
