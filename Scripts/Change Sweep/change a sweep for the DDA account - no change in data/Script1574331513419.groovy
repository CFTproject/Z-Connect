...
for (int i = 10; i < 11; i++) {
    ...
    response = WS.sendRequest(findTestObject('Change Sweep/change a sweep for the DDA account - no change in data', [('companyNbr') : testdatapath.getValue(
                    2, i), ('sweepType') : testdatapath.getValue(3, i), ('originatingCompanyNbr') : testdatapath.getValue(
                    22, i), ('originatingAccountNbr') : testdatapath.getValue(4, i), ('sweepSequenceNbr') : testdatapath.getValue(
                    5, i), ('relatedCompanyNbr') : testdatapath.getValue(23, i), ('relatedProductCd') : testdatapath.getValue(
                    6, i), ('relatedAccountNbr') : testdatapath.getValue(24, i), ('relatedExecSequenceNbr') : testdatapath.getValue(
                    7, i)]))
