...
for (int i = 1; i < 8; i++) {
    ...
    response = WS.sendRequest(findTestObject('Change Address/Change Address Patch Request Verify Response with valid Values', 
            [('actionCode') : findTestData('Z-Connect Test Data/Change Address_TestData').getValue(2, i), ('presentAddressLine1') : findTestData(
                ...
                , ('chgAddressLine3') : findTestData('Z-Connect Test Data/Change Address_TestData').getValue(9, i), ('chgCity') : findTestData(
                    'Z-Connect Test Data/Change Address_TestData').getValue(10, i), ('chgState') : findTestData('Z-Connect Test Data/Change Address_TestData').getValue(
   ...
   WS.verifyElementPropertyValue(response, 'changeAddressServiceOperationResponse.RESPONSE.Output.xStatus.statusCd', findTestData('Z-Connect Test Data/Change Address_TestData').getValue(16, i))
   
   WS.verifyElementPropertyValue(response, 'changeAddressServiceOperationResponse.RESPONSE.Output.xStatus.statusMessage', findTestData('Z-Connect Test Data/Change Address_TestData').getValue(17, i))
   
   WS.verifyElementPropertyValue(response, 'changeAddressServiceOperationResponse.RESPONSE.Output.xStatus.severity', findTestData('Z-Connect Test Data/Change Address_TestData').getValue(18, i))
}
