...
for (int i = 11; i < 12; i++) {
    ...
    response = WS.sendRequest(findTestObject('Change Address/Change Address Patch Request Verify Response with Empty Values', 
            [('actionCode') : testdatapath.getValue(2, i), ('presentAddressLine1') : testdatapath.getValue(3, i), ('presentAddressLine2') : testdatapath.getValue(
                    ...
                    6, i), ('chgCity') : testdatapath.getValue(10, i), ('userAcknowledge') : testdatapath.getValue(13, i)]))
