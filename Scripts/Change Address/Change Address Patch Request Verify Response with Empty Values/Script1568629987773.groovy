...
for (int i = 11; i < 12; i++) {
    ...
    response = WS.sendRequest(findTestObject('Change Address/Change Address Patch Request Verify Response with Empty Values', 
            [('actionCode') : findTestData('Z-Connect Test Data/Change Address_TestData').getValue(2, i), ('presentAddressLine1') : findTestData(
                    ...
                    6, i), ('chgCity') : findTestData('Z-Connect Test Data/Change Address_TestData').getValue(10, i), ('userAcknowledge') : findTestData(
                    'Z-Connect Test Data/Change Address_TestData').getValue(13, i)]))
