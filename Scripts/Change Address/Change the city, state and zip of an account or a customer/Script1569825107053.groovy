...
for (int i = 8; i < 9; i++) {
    ...
    response = WS.sendRequest(findTestObject('Change Address/Change the city, state and zip of an account or a customer', 
            [('actionCode') : testdatapath.getValue(2, i), ('presentAddressLine1') : testdatapath.getValue(3, i), ('presentAddressLine2') : testdatapath.getValue(
                    ...
                    6, i), ('chgCity') : testdatapath.getValue(10, i), ('chgState') : findTestData('Z-Connect Test Data/Change Address_TestData').getValue(
                    11, i), ('chgPostalCd') : testdatapath.getValue(12, i), ('userAcknowledge') : testdatapath.getValue(
                    13, i)]))
