...
for (int i = 13; i < 16; i++) {
    ...
    //Change review date for DDA
    if (i == 13) {
        response = WS.sendRequest(findTestObject('Change Restraint PledgeTo/Change review date for DDA', 
                [('restraintPldgKeyCompanyNbr') : findTestData('Z-Connect Test Data/Change Restraint PledgeTo_TestData').getValue(
                        ...
                        8, i), ('restraintPldgLastReviewDt') : findTestData('Z-Connect Test Data/Change Restraint PledgeTo_TestData').getValue(
                        12, i)]))
    }
	
	//Change review date for REA
	if (i == 14) {
		response = WS.sendRequest(findTestObject('Change Restraint PledgeTo/Change review date for REA',
				[('restraintPldgKeyCompanyNbr') : findTestData('Z-Connect Test Data/Change Restraint PledgeTo_TestData').getValue(
						2, i), ('restraintPldgKeyProductCode') : findTestData('Z-Connect Test Data/Change Restraint PledgeTo_TestData').getValue(
						3, i), ('restraintPldgKeyAccountNbr') : findTestData('Z-Connect Test Data/Change Restraint PledgeTo_TestData').getValue(
						4, i), ('restraintPldgKeyType') : findTestData('Z-Connect Test Data/Change Restraint PledgeTo_TestData').getValue(
	...
	//Change review date for CDA
	if (i == 15) {
		response = WS.sendRequest(findTestObject('Change Restraint PledgeTo/Change review date for CDA',
				[('restraintPldgKeyCompanyNbr') : findTestData('Z-Connect Test Data/Change Restraint PledgeTo_TestData').getValue(
						2, i), ('restraintPldgKeyProductCode') : findTestData('Z-Connect Test Data/Change Restraint PledgeTo_TestData').getValue(
						3, i), ('restraintPldgKeyAccountNbr') : findTestData('Z-Connect Test Data/Change Restraint PledgeTo_TestData').getValue(
						4, i), ('restraintPldgKeyType') : findTestData('Z-Connect Test Data/Change Restraint PledgeTo_TestData').getValue(
