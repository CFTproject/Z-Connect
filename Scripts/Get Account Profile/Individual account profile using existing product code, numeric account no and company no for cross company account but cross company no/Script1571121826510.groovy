...
response = WS.sendRequest(findTestObject('Get Account Profile/Individual account profile using existing product code, numeric account no and company no for cross company account but cross company no'))
