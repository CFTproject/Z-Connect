...
WS.verifyElementPropertyValue(response, 'getAccountProfileServiceOperationResponse.RESPONSE.Output.xStatus.applicationCd', findTestData('Z-Connect Test Data/Get Account Profile_TestData').getValue(2, i))
