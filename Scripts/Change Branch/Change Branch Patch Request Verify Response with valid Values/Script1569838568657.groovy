...
for (int i = 1; i < 6; i++) {
    ...
    println('APPLICATION CODE : ' + findTestData('Z-Connect Test Data/Change Branch_TestData').getValue(73, i))

    println('STATUS CODE : ' + findTestData('Z-Connect Test Data/Change Branch_TestData').getValue(74, i))

    println('STATUS MESSAGE : ' + findTestData('Z-Connect Test Data/Change Branch_TestData').getValue(75, i))

    println('SEVERITY : ' + findTestData('Z-Connect Test Data/Change Branch_TestData').getValue(76, i))
	...
	if (i == 5) {
		response = WS.sendRequest(findTestObject('Change Branch/Change ATM OP CL hours', [('branchNbr') : findTestData(
						'Z-Connect Test Data/Change Branch_TestData').getValue(4, i), ('owner') : findTestData('Z-Connect Test Data/Change Branch_TestData').getValue(
						5, i), ('changeControlNbr') : findTestData('Z-Connect Test Data/Change Branch_TestData').getValue(
						6, i), ('lastChangeDate') : findTestData('Z-Connect Test Data/Change Branch_TestData').getValue(
						7, i), ('lastChangeTime') : findTestData('Z-Connect Test Data/Change Branch_TestData').getValue(
						8, i), ('atmOpenMondayTime') : findTestData('Z-Connect Test Data/Change Branch_TestData').getValue(
						54, i), ('atmClosedMondayTime') : findTestData('Z-Connect Test Data/Change Branch_TestData').getValue(
						55, i), ('atmOpenTuesdayTime') : findTestData('Z-Connect Test Data/Change Branch_TestData').getValue(
						56, i), ('atmClosedTuesdayTime') : findTestData('Z-Connect Test Data/Change Branch_TestData').getValue(
						57, i), ('atmOpenWednesdayTime') : findTestData('Z-Connect Test Data/Change Branch_TestData').getValue(
						58, i), ('atmClosedWednesdayTime') : findTestData('Z-Connect Test Data/Change Branch_TestData').getValue(
						59, i), ('atmOpenThursdayTime') : findTestData('Z-Connect Test Data/Change Branch_TestData').getValue(
						60, i), ('atmClosedThursdayTime') : findTestData('Z-Connect Test Data/Change Branch_TestData').getValue(
						61, i), ('atmOpenFridayTime') : findTestData('Z-Connect Test Data/Change Branch_TestData').getValue(
						62, i), ('atmClosedFridayTime') : findTestData('Z-Connect Test Data/Change Branch_TestData').getValue(
						63, i), ('atmOpenSaturdayTime') : findTestData('Z-Connect Test Data/Change Branch_TestData').getValue(
						64, i), ('atmClosedSaturdayTime') : findTestData('Z-Connect Test Data/Change Branch_TestData').getValue(
						65, i), ('atmOpenSundayTime') : findTestData('Z-Connect Test Data/Change Branch_TestData').getValue(
						66, i), ('atmClosedSundayTime') : findTestData('Z-Connect Test Data/Change Branch_TestData').getValue(
						67, i)]))
	}
    
    WS.verifyResponseStatusCode(response, 200)

    WS.verifyElementPropertyValue(response, 'changeBranchServiceOperationResponse.RESPONSE.Output.XSTATUS.applicationCd', 
        findTestData('Z-Connect Test Data/Change Branch_TestData').getValue(73, i))

    WS.verifyElementPropertyValue(response, 'changeBranchServiceOperationResponse.RESPONSE.Output.XSTATUS.statusCd', findTestData(
            'Z-Connect Test Data/Change Branch_TestData').getValue(74, i))

    WS.verifyElementPropertyValue(response, 'changeBranchServiceOperationResponse.RESPONSE.Output.XSTATUS.statusMessage', 
        findTestData('Z-Connect Test Data/Change Branch_TestData').getValue(75, i))

    WS.verifyElementPropertyValue(response, 'changeBranchServiceOperationResponse.RESPONSE.Output.XSTATUS.severity', findTestData(
            'Z-Connect Test Data/Change Branch_TestData').getValue(76, i))
}