...
for (int i = 7; i < 8; i++) {
   ...
   /* WS.verifyElementPropertyValue(response, 'errorMessage', testdatapath.getValue(31, i))

    WS.verifyElementPropertyValue(response, 'errorDetails', testdatapath.getValue(32, i))*/
}