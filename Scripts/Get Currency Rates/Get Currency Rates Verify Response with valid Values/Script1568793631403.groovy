...
response = WS.sendRequest(findTestObject('Get Currency Rates/Get Currency Rates Verify Response with valid Values'))
...
for (int i = 1; i < 2; i++) {
	...
	WS.verifyElementPropertyValue(response, 'getCurrencyRatesServiceOperationResponse.RESPONSE.Output.companyNbr',
		findTestData('Z-Connect Test Data/Get Currency Rates_TestData').getValue(6, i))
	...
	WS.verifyElementPropertyValue(response, 'getCurrencyRatesServiceOperationResponse.RESPONSE.Output.owner',
		findTestData('Z-Connect Test Data/Get Currency Rates_TestData').getValue(8, i))
	
	WS.verifyElementPropertyValue(response, 'getCurrencyRatesServiceOperationResponse.RESPONSE.Output.fromCurrency',
		findTestData('Z-Connect Test Data/Get Currency Rates_TestData').getValue(9, i))
	
	WS.verifyElementPropertyValue(response, 'getCurrencyRatesServiceOperationResponse.RESPONSE.Output.rateType',
		findTestData('Z-Connect Test Data/Get Currency Rates_TestData').getValue(10, i))
	
	WS.verifyElementPropertyValue(response, 'getCurrencyRatesServiceOperationResponse.RESPONSE.Output.effectiveDate',
		findTestData('Z-Connect Test Data/Get Currency Rates_TestData').getValue(11, i))
	
	WS.verifyElementPropertyValue(response, 'getCurrencyRatesServiceOperationResponse.RESPONSE.Output.effectiveTime',
		findTestData('Z-Connect Test Data/Get Currency Rates_TestData').getValue(12, i))
