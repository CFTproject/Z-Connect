...
for (int i = 3; i < 4; i++) {
    ...
    response = WS.sendRequest(findTestObject('Change Customer/Change Customer For individual customer in CUAI screen', [
                ('inputKey') : findTestData('Z-Connect Test Data/Change Customer_TestData').getValue(2, i), ('customerTie') : findTestData(
                    ...
                    5, i), ('birthState') : findTestData('Z-Connect Test Data/Change Customer_TestData').getValue(6, i), ('birthCity') : findTestData(
                    'Z-Connect Test Data/Change Customer_TestData').getValue(7, i), ('privacyDeliveryDt') : findTestData(
                    'Z-Connect Test Data/Change Customer_TestData').getValue(8, i), ('privacyFormReceiptDt') : findTestData(
                    'Z-Connect Test Data/Change Customer_TestData').getValue(9, i), ('documentNbr') : findTestData('Z-Connect Test Data/Change Customer_TestData').getValue(
                    10, i), ('documentissuePlace') : findTestData('Z-Connect Test Data/Change Customer_TestData').getValue(
                    11, i), ('batchNbr') : findTestData('Z-Connect Test Data/Change Customer_TestData').getValue(12, i)]))
