...
response = WS.sendRequest(findTestObject('Get Address Relationships/Get valid address with offsetCustomer offsetAccount LimitCustomer LimitAccount all as 1'))
