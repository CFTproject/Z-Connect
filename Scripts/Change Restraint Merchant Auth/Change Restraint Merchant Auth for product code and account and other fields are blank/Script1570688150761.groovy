...
for (int i = 1; i < 4; i++) {
	...
	//Change record with all blank input fields
	if(i == 1){		
	
    response = WS.sendRequest(findTestObject('Change Restraint Merchant Auth/Change record with all blank input fields', 
	...
	//Change record with non blank account no and all other blank input fields
	if(i == 2){
	
	response = WS.sendRequest(findTestObject('Change Restraint Merchant Auth/Change record with non blank account no and all other blank input fields',
			[('restraintMchKeyCompanyNbr') : findTestData('Z-Connect Test Data/Change Restraint Merchant Auth_TestData').getValue(
					2, i), ('restraintMchKeyProductCode') : findTestData('Z-Connect Test Data/Change Restraint Merchant Auth_TestData').getValue(
					3, i), ('restraintMchKeyAccountNbr') : findTestData('Z-Connect Test Data/Change Restraint Merchant Auth_TestData').getValue(
					4, i), ('restraintMchVarKeyExpireDt') : findTestData('Z-Connect Test Data/Change Restraint Merchant Auth_TestData').getValue(
	...
	//CHange record with non blank product code and account no fields and all other blank input fields
	if(i == 3){
	
	response = WS.sendRequest(findTestObject('Change Restraint Merchant Auth/CHange record with non blank product code and account no fields and all other blank input fields',
			[('restraintMchKeyCompanyNbr') : findTestData('Z-Connect Test Data/Change Restraint Merchant Auth_TestData').getValue(
					2, i), ('restraintMchKeyProductCode') : findTestData('Z-Connect Test Data/Change Restraint Merchant Auth_TestData').getValue(
					3, i), ('restraintMchKeyAccountNbr') : findTestData('Z-Connect Test Data/Change Restraint Merchant Auth_TestData').getValue(
					4, i), ('restraintMchVarKeyExpireDt') : findTestData('Z-Connect Test Data/Change Restraint Merchant Auth_TestData').getValue(
