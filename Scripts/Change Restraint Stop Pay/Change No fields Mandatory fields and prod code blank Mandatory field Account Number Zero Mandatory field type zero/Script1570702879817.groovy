...
for (int i = 8; i < 12; i++) {
    ...
    //Change No fields
    if (i == 8) {
        response = WS.sendRequest(findTestObject('Change Restraint Stop Pay/Change No fields', [('restraintStpKeyCompanyNbr') : findTestData(
    ...
    //Change Mandatory fields and prod code blank
    if (i == 9) {
        response = WS.sendRequest(findTestObject('Change Restraint Stop Pay/Change Mandatory fields and prod code blank', 
                [('restraintStpKeyCompanyNbr') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
                        2, i), ('restraintStpKeyProductCode') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
                        3, i), ('restraintStpKeyAccountNbr') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
                        4, i), ('restraintStpKeyType') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
                        5, i), ('restraintStpVarKeyHighCheckNbr') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
                        6, i), ('restraintStpVarKeyLowCheckNbr') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
                        7, i), ('restraintStpVarKeyHighCheckAmt') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
                        8, i), ('restraintStpVarKeyLowCheckAmt') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
                        9, i), ('restraintStpVarKeyExpireDt') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
                        10, i), ('restraintStpVarKeyPlacedDt') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
                        11, i), ('restraintStpCheckDt') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
                        12, i), ('restraintStpLastCheckReturnedDt') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
                        13, i), ('restraintStpPayee') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
                        14, i), ('restraintStpChecksoutstandingNbr') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
                        15, i), ('restraintStpChecksReturnedNbr') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
                        16, i), ('restraintStpComment1') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
                        17, i), ('restraintStpComment2') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
                        18, i), ('restraintStpReason1') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
                        19, i), ('restraintStpReason2') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
                        20, i)]))
    }
	
	//Change Mandatory field Account Number Zero
	if (i == 10) {
		response = WS.sendRequest(findTestObject('Change Restraint Stop Pay/Change Mandatory field Account Number Zero',
				[('restraintStpKeyCompanyNbr') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
						2, i), ('restraintStpKeyProductCode') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
						3, i), ('restraintStpKeyAccountNbr') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
						4, i), ('restraintStpKeyType') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
	...
	//Change Mandatory field type zero
	if (i == 11) {
		response = WS.sendRequest(findTestObject('Change Restraint Stop Pay/Change Mandatory field type zero',
				[('restraintStpKeyCompanyNbr') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
						2, i), ('restraintStpKeyProductCode') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
						3, i), ('restraintStpKeyAccountNbr') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
						4, i), ('restraintStpKeyType') : findTestData('Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(
