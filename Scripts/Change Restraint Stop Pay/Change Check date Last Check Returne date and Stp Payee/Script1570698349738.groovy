...
for (int i = 1; i < 4; i++) {
    ...
    //Change Check date
    if (i == 1) {
        response = WS.sendRequest(findTestObject('Change Restraint Stop Pay/Change Check date', [('restraintStpKeyCompanyNbr') : findTestData(
    ...
    //Change Last Check Returne date
    if (i == 2) {
        response = WS.sendRequest(findTestObject('Change Restraint Stop Pay/Change Last Check Returne date', [('restraintStpKeyCompanyNbr') : findTestData(
                        'Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(2, i), ('restraintStpKeyProductCode') : findTestData(
                        'Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(3, i), ('restraintStpKeyAccountNbr') : findTestData(
                        'Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(4, i), ('restraintStpKeyType') : findTestData(
                        'Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(5, i), ('restraintStpVarKeyHighCheckNbr') : findTestData(
    ...
    //Change Stp Payee
    if (i == 3) {
        response = WS.sendRequest(findTestObject('Change Restraint Stop Pay/Change Stp Payee', [('restraintStpKeyCompanyNbr') : findTestData(
                        'Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(2, i), ('restraintStpKeyProductCode') : findTestData(
                        'Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(3, i), ('restraintStpKeyAccountNbr') : findTestData(
                        'Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(4, i), ('restraintStpKeyType') : findTestData(
                        'Z-Connect Test Data/Change Restraint Stop Pay_TestData').getValue(5, i), ('restraintStpVarKeyHighCheckNbr') : findTestData(
