...
for (int i = 12; i < 13; i++) {
    ...
    response = WS.sendRequest(findTestObject('Create Sweep/Create a sweep for the DDA account for sweep type OD inv instr cde for driver type', [('companyNbr') : testdatapath.getValue(
