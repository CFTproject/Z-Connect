...
for (int i = 2; i < 3; i++) {
    ...
    response = WS.sendRequest(findTestObject('Create Sweep/Create a sweep for the DDA account for sweep type CD and Account not unique', 
            [('companyNbr') : testdatapath.getValue(2, i), ('sweepType') : testdatapath.getValue(3, i), ('originatingCompanyNbr') : testdatapath.getValue(
