...
for (int i = 1; i < 2; i++) {
    ...
    response = WS.sendRequest(findTestObject('Get Sweep Summary/transferDebitRelatedAcctCount transferSweepRelatedAcctCount transferSweepCount odProtectionRelatedAcctCount'))
