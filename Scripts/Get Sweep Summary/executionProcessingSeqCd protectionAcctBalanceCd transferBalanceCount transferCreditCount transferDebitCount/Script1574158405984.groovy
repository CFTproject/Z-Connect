...
for (int i = 3; i < 4; i++) {
    ...
    response = WS.sendRequest(findTestObject('Get Sweep Summary/executionProcessingSeqCd protectionAcctBalanceCd transferBalanceCount transferCreditCount transferDebitCount'))
