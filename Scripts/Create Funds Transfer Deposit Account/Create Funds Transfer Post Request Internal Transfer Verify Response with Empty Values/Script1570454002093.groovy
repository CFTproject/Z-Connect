...
response = WS.sendRequest(findTestObject('Create Funds Transfer Deposit Account/Create Funds Transfer Post Request Internal Transfer Verify Response with Empty Values'))
...
WS.verifyElementPropertyValue(response, 'createFundsTransferDepositAccountServiceOperationResponse.RESPONSE.Output.xStatus.statusMessage', findTestData('Z-Connect Test Data/Create Funds Transfer Deposit Account_TestData').getValue(4, i))
