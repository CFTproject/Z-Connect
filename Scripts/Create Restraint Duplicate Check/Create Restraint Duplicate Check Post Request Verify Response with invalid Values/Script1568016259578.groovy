...
for (int i = 5; i <7; i++) {
    ...
    response = WS.sendRequest(findTestObject('Create Restraint Duplicate Check/Create Restraint Duplicate Check Post Request Verify Response with invalid Values', 
