...
for (int i = 4; i < 5; i++) {
    ...
    response = WS.sendRequest(findTestObject('Get Direct Debit Deposit Account List/ProductCd of DDA accountNbr 7 offsetHi of spaces offsetLo of spaces limit of 4'))
