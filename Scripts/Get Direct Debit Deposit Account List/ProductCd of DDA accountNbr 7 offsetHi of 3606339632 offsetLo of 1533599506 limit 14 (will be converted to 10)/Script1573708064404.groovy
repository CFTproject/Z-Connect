...
for (int i = 7; i < 8; i++) {
    ...
    response = WS.sendRequest(findTestObject('Get Direct Debit Deposit Account List/ProductCd of DDA accountNbr 7 offsetHi of 3606339632 offsetLo of 1533599506 limit 14 (will be converted to 10)'))
