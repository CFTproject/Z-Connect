...
for (int i = 5; i < 6; i++) {
    ...
    response = WS.sendRequest(findTestObject('Get Direct Debit Deposit Account List/ProductCd of DDA accountNbr 7 offsetHi of 0 offsetLo of 0 limit of 11 Limit of limit is 10 11 will be converted to 10'))
