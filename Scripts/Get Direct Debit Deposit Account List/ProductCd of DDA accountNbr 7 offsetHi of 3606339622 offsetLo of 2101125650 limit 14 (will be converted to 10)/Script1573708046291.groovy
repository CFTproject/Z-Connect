...
for (int i = 6; i < 7; i++) {
    ...
    response = WS.sendRequest(findTestObject('Get Direct Debit Deposit Account List/ProductCd of DDA accountNbr 7 offsetHi of 3606339622 offsetLo of 2101125650 limit 14 (will be converted to 10)'))
