...
for (int i = 2; i < 3; i++) {
    ...
    response = WS.sendRequest(findTestObject('Get Direct Debit Deposit Account List/ProductCd of DDA accountNbr 7 offsetHi of 3606339622 offsetLo of 2101125650'))
