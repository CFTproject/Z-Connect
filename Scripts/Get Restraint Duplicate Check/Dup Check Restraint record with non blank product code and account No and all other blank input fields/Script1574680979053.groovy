...
for (int i = 2; i < 3; i++) {
    response = WS.sendRequest(findTestObject('Get Restraint Duplicate Check/Dup Check Restraint record with non blank product code and account No and all other blank input fields'))
