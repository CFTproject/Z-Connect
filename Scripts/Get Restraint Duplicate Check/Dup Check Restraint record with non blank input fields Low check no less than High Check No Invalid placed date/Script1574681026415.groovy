...
for (int i = 4; i < 5; i++) {
    response = WS.sendRequest(findTestObject('Get Restraint Duplicate Check/Dup Check Restraint record with non blank input fields Low check no less than High Check No Invalid placed date'))
