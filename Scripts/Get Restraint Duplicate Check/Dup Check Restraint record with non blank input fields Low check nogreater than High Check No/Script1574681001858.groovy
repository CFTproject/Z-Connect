...
for (int i = 3; i < 4; i++) {
    response = WS.sendRequest(findTestObject('Get Restraint Duplicate Check/Dup Check Restraint record with non blank input fields Low check nogreater than High Check No'))
