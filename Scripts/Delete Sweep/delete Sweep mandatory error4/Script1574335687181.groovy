...
for (int i = 6; i < 7; i++) {
    ...
    response = WS.sendRequest(findTestObject('Delete Sweep/delete Sweep mandatory error4', [('sweepType') : testdatapath.getValue(
                    3, i), ('originatingCompanyNbr') : testdatapath.getValue(4, i), ('originatingAccountNbr') : testdatapath.getValue(
