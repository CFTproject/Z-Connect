...
for (int i = 3; i < 4; i++) {
    ...
    response = WS.sendRequest(findTestObject('Delete Sweep/delete sweep Success', [('sweepType') : testdatapath.getValue(
                    3, i), ('originatingCompanyNbr') : testdatapath.getValue(4, i), ('originatingProductCd') : testdatapath.getValue(
                    5, i), ('originatingAccountNbr') : testdatapath.getValue(6, i), ('sweepSequenceNbr') : testdatapath.getValue(
                    7, i), ('relatedProductCd') : testdatapath.getValue(8, i)]))
