...
for (int i = 5; i < 6; i++) {
    ...
    response = WS.sendRequest(findTestObject('Delete Restraint Duplicate Check/Non blank input fields Low check no less than High Check No and Invalid placed date', 
