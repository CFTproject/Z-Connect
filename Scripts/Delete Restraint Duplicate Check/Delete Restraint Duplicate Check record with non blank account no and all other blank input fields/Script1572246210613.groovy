...
for (int i = 2; i < 3; i++) {
    ...
    response = WS.sendRequest(findTestObject('Delete Restraint Duplicate Check/Delete Restraint Duplicate Check record with non blank account no and all other blank input fields', 
