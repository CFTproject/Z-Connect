...
response = WS.sendRequest(findTestObject('Get Funds Transfer Deposit Account List/Get Funds Transfer Deposit Account List Verify Response with valid Values'))
