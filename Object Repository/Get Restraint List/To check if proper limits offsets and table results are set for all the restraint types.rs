...
<WebServiceRequestEntity>
   ...
   <name>To check if proper limits offsets and table results are set for all the restraint types</name>
   <tag></tag>
   <elementGuidId>8ede3079-f14f-46e0-bad9-890ff906d0e7</elementGuidId>
